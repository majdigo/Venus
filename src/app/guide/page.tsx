        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <section className="relative pt-32 pb-20 px-4 bg-brand-navy overflow-hidden">
                ...
                <div className="container mx-auto max-w-5xl relative z-10 text-center text-white">
                    ...
                    <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6 tracking-tight leading-tight">
                        Votre Voyage Médical en <span className="text-brand-gold">Tunisie</span>
                    </h1>
            ...
            <section className="py-24 px-4 bg-white">
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-16">
                        <span className="text-brand-gold font-bold tracking-wider uppercase text-sm mb-2 block">Destination d'Excellence</span>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-slate-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all duration-300">
                            <div className="w-14 h-14 rounded-2xl bg-brand-gold/10 flex items-center justify-center mb-6">
                                <Stethoscope className="text-brand-gold w-7 h-7" />
                            </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all duration-300">
                            <div className="w-14 h-14 rounded-2xl bg-brand-gold/10 flex items-center justify-center mb-6">
                                <Shield className="text-brand-gold w-7 h-7" />
                            </div>
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all duration-300">
                            <div className="w-14 h-14 rounded-2xl bg-brand-gold/10 flex items-center justify-center mb-6">
                                <Sun className="text-brand-gold w-7 h-7" />
                            </div>
            ...
            <section className="py-24 px-4 bg-brand-navy text-white">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-brand-gold/50 before:to-transparent">

                        {/* Etape 1 */}
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-brand-navy bg-brand-gold shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow sm:w-14 sm:h-14 font-bold relative z-10 text-white">
                                1
                            </div>
