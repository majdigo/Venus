            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-gold/10 text-brand-gold font-medium text-sm mb-6"
                    >
                    ...
                    >
                        Comment se pose une <span className="text-brand-gold">Facette</span> ?
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
                        ...
                        <div className="relative aspect-[3/4] w-full bg-gradient-to-br from-indigo-50 to-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex items-center justify-center p-8">
                            ...
                            <AnimatePresence>
                                {activeStep.id === "resultat" && (
                                    ...
                                    >
                                        <div className="absolute top-[20%] right-[20%] text-brand-gold animate-bounce"><Sparkles size={24} /></div>
                                        <div className="absolute bottom-[30%] left-[15%] text-brand-gold/60 animate-pulse"><Sparkles size={16} /></div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                    ...
                    <div className="w-full max-w-lg">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="absolute -right-8 -top-8 text-brand-gold/5 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-700">
