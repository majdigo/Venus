...
const MOCK_DOCTORS: Doctor[] = [
    { id: 1, slug: 'dr-walid-balti', name: 'Dr Walid Balti', specialty: 'Chirurgie Plastique, Esthétique et Reconstructrice', image_url: 'https://venus-estetika.com/wp-content/uploads/2019/02/dr-walid-balti.jpg', is_featured: true },
    { id: 2, slug: 'dr-atef-ghedira', name: 'Dr Atef Ghedira', specialty: 'Chirurgie Plastique, Esthétique et Reconstructrice', image_url: 'https://venus-estetika.com/wp-content/uploads/2022/11/dr-atef-ghedira-1.jpg', is_featured: true },
    { id: 3, slug: 'dr-imen-ben-gaied', name: 'Dr Imen Ben Gaied', specialty: 'Chirurgie Plastique, Esthétique et Reconstructrice', image_url: 'https://venus-estetika.com/wp-content/uploads/2024/09/Capture-decran-2024-09-02-120757.png', is_featured: true },
    { id: 4, slug: 'dr-ramzi-nouira', name: 'Dr Ramzi Nouira', specialty: 'Chirurgie Bariatrique (Obésité)', image_url: 'https://venus-estetika.com/wp-content/uploads/2019/02/dr-ramzi-nouira.jpg', is_featured: true },
    { id: 5, slug: 'dr-samaher-bouchnak', name: 'Dr Samaher Bouchnak', specialty: 'Greffe Capillaire, Médecine Esthétique', image_url: 'https://venus-estetika.com/wp-content/uploads/2022/11/dr-samaher-bouchnak-1.jpg', is_featured: true },
    { id: 6, slug: 'dr-ramses-mouelhi', name: 'Dr Ramses Mouelhi', specialty: 'Chirurgien Dentiste (Implantologie & Facettes)', image_url: 'https://venus-estetika.com/wp-content/uploads/2022/11/dr-ramses-mouelhi-1.jpg', is_featured: true },
];

const MOCK_INTERVENTIONS: Intervention[] = [
    { id: 101, slug: 'rhinoplastie', category_slug: 'chirurgie-visage', category_name: 'Chirurgie du Visage', title: 'Rhinoplastie', price_min: 2200, price_max: 3200, description_short: 'Remodelage esthétique et fonctionnel du nez.', featured_doctors_slugs: ['dr-walid-balti', 'dr-imen-ben-gaied'] },
    { id: 102, slug: 'lifting-cervico-facial', category_slug: 'chirurgie-visage', category_name: 'Chirurgie du Visage', title: 'Lifting Cervico-Facial', price_min: 3500, description_short: 'Rajeunissement global de l\'ovale du visage et du cou.', featured_doctors_slugs: ['dr-atef-ghedira'] },
    { id: 103, slug: 'blepharoplastie', category_slug: 'chirurgie-visage', category_name: 'Chirurgie du Visage', title: 'Blépharoplastie', price_min: 1500, description_short: 'Chirurgie des paupières pour un regard rajeuni.', featured_doctors_slugs: ['dr-walid-balti'] },
    ...
    { id: 301, slug: 'abdominoplastie', category_slug: 'chirurgie-silhouette', category_name: 'Chirurgie de la Silhouette', title: 'Abdominoplastie', price_min: 2900, description_short: 'Remise en tension de la paroi abdominale et retrait d\'excédent cutané.', featured_doctors_slugs: ['dr-walid-balti'] },
    { id: 302, slug: 'liposuccion', category_slug: 'chirurgie-silhouette', category_name: 'Chirurgie de la Silhouette', title: 'Liposuccion', price_min: 2000, price_max: 3000, description_short: 'Aspiration des amas graisseux localisés.', featured_doctors_slugs: ['dr-atef-ghedira'] },
